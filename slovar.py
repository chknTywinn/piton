...
# {"ključ" : "vrednost", "ključ2" : "vrednosti"}

imenik = { "Luka":"040222333",
           "Bine":"031555666"}
print(type(imenik))
print(imenik)

#nevarni klic - napaka, če ključ ne obstaja
print(imenik["Luka"])
if "Nejc" in imenik:
    print(imenik["Nejc"])
else:
...
#varni klic - default vrednost, če ključ ne obstaja
print(imenik.get("Luka"))
print(imenik.get("Nejc", "če ni nč pol to pride"))

#pisanje v slovar
print(imenik)
imenik["Luka"]="123456789"
print(imenik)

#preštej znake (črke), v Shrak movie scrnariju
